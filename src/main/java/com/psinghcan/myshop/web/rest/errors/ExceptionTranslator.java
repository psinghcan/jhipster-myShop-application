...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.psinghcan.myshop.service.EmailAlreadyUsedException ||
            ex instanceof com.psinghcan.myshop.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.psinghcan.myshop.service.InvalidPasswordException
